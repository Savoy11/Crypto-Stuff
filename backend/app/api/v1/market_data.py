...
async def get_asset_liquidity(
    ...
    if not liq:
        return _envelope({"asset_id": str(asset_id), "data": None, "message": "No liquidity data available"})
    ...
    return _envelope({
        ...
        "total_liquidity_usd": float(liq.total_liquidity_usd) if liq.total_liquidity_usd else None,
