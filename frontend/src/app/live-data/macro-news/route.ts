...
const STRONG_CURRENCY = /\b(euro|yen|sterling|pound|franc|yuan|renminbi|peso|rupee|rand|lira|forint|zloty|krona|koruna|loonie|aussie|kiwi|(canadian|australian|new zealand|hong kong|singapore) dollar|forex|fx\b|currency pair[s]?|dollar index|dxy|carry trade|devalu\w+|[a-z]{3}\/[a-z]{3})\b/i
...
function classifyPillar(text: string, fallback: MacroPillar | null): MacroPillar | null {
