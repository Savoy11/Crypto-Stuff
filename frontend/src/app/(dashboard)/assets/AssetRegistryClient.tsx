      ...
      {tab === 'coins' && (
        <div className="space-y-5">
          ...
          <p className="text-[11px] text-text-muted text-center">
            Live prices via CoinGecko · Safety Scores are Finance Now Free&apos;s own computed analytics (0–100, higher = safer), not a provider&apos;s figure and not investment advice
          </p>
        </div>
      )}
