...
const SPEC = {
  openapi: '3.0.3',
  info: {
    title: 'Finance Now Free API',
    version: '1.0.0',
    description: 'Finance Now Free — programmatic access to transfer fee routing, staking opportunity analysis, live network fees, coin prices, and crypto news with sentiment. Designed for AI agents and automated workflows.',
    contact: { name: 'Finance Now Free', url: 'http://localhost:3000' },
  },
  servers: [
