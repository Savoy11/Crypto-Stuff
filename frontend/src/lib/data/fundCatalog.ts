...
export const FUND_CATALOG: FundEntry[] = [
  ...
  { symbol: 'VTEB', name: 'Vanguard Tax-Exempt Bond ETF', type: 'etf', issuer: 'Vanguard', category: 'bond', expenseRatioPct: 0.05, aumB: 35, referencePrice: 50, yieldPct: 3.4, inceptionYear: 2015, indexTracked: 'S&P National AMT-Free Municipal Bond', topHoldings: [], website: 'https://investor.vanguard.com/investment-products/etfs/profile/vteb', description: 'Vanguard’s national muni fund — MUB’s twin at the same fee.' },
