...
| Compare | `/compare` | `security-chart` history | 2–4 stocks/funds, normalized growth-of-100 + stats table |
| Daily Brief | `/brief` | Research agent + live routes | AI morning brief grounded in the user's holdings (needs ANTHROPIC_API_KEY) |
| Market Calendar | `/equities/calendar` | FMP calendars (free key) | 14-day earnings (catalog-first) + US economic events |
